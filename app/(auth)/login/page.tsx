...
function LoginContent() {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-zinc-50 dark:bg-black px-4">
      <div className="w-full max-w-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
        <SmartCard variant="static" className="p-8">
          <div className="mb-8 text-center space-y-2">
            <h1 className="text-2xl font-serif font-semibold tracking-tight text-zinc-900 dark:text-white">
              Welcome back
            </h1>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            {error && (
              <div className="text-sm text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/10 p-3 rounded-lg border border-red-100 dark:border-red-900/20">
                {error}
              </div>
            )}

            <PremiumButton className="w-full" type="submit" disabled={isLoading}>
          ...
          <p className="mt-6 text-center text-sm text-zinc-500">
            ...
            <a href="/signup" className="text-zinc-900 dark:text-white hover:underline font-medium">
              Sign up
            </a>
          </p>
        </SmartCard>
    ...
    <Suspense fallback={
      <div className="flex h-screen w-full items-center justify-center bg-zinc-50 dark:bg-black px-4">
        <div className="w-full max-w-sm">
          <SmartCard variant="static" className="p-8 flex items-center justify-center min-h-[400px]">
